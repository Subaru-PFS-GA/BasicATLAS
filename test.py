...
no_hash = ['bin/atlas9mem.exe', 'bin/dfsortp.exe', 'bin/dfsynthe.exe', 'bin/kappa9.exe', 'bin/kapreadts.exe', 'bin/separatedf.exe', 'bin/xnfdf.exe', 'bin/rgfalllinesnew.exe', 'bin/rmolecasc.exe',
           'bin/spectrv.exe', 'bin/synthe.exe', 'bin/xnfpelsyn.exe', 'bin/rh2ofast.exe', 'bin/rpredict.exe', 'bin/synbeg.exe', 'data/dfsynthe_files/diatomicsdf.bin', 'data/dfsynthe_files/h2olinesdf.bin',
           'data/dfsynthe_files/highlinesdf.bin', 'data/dfsynthe_files/lowlinesdf.bin', 'data/dfsynthe_files/nltelinesdf.bin', 'data/dfsynthe_files/tiolinesdf.bin']
